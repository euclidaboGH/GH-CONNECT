  ...
  return NextResponse.json(
    {
      ...
      notes: [
        ...
        "Wire Pi.authenticate(scopes, onIncompletePaymentFound) → POST /api/payments/incomplete.",
        "Payment intents persist via ghc_payment_intents when Supabase is configured.",
      ],
